...
TWILIO_SID = 'AC7717fc385aafef10db33e49d6f946438'
TWILIO_AUTH_TOKEN = '55e67237d2e1def61aa2a7c75a958526'
TWILIO_PHONE_NUMBER = '+12396630538'
...
def send_emergency_sms():
    ...
    emergency_contacts_list = ["+999", "+971508616120"]  # Add SOS and user contacts here
...
heartbeat_icon = ctk.CTkLabel(heartbeat_frame, text="❤️", font=("Arial", 18), text_color="#FF5252")
...
map_label = ctk.CTkLabel(map_preview_frame, text="🗺️", font=("Arial", 40), text_color="#333333")
